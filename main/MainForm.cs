...
namespace main
{
    public partial class MainForm : Form
    {
        ...
        {
            if (StartPointBox.SelectedItem == null) return RFLActionResult.START_CITY_EMPTY;
            ...
            else if (Data.GetCitiesList().Count == 0 || Data.GetRoutesList().Count == 0) return RFLActionResult.DATABASE_IS_EMPTY;
